/***************************************************************************************************
FILENAME: 001-Create DVDStore Database and Schema
***************************************************************************************************/

/***************************************************************************************************
NOTES: Create DVDStore Database and Schema for Microsoft SQL Server
***************************************************************************************************/
...
GO
ALTER TABLE actor
ADD CONSTRAINT [DF_actor_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE country
ADD CONSTRAINT [DF_country_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE city
ADD CONSTRAINT [DF_city_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE address
ADD CONSTRAINT [DF_address_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
CREATE INDEX idx_fk_city_id ON address(city_id); 
GO
ALTER TABLE address
ADD CONSTRAINT fk_address_city FOREIGN KEY(city_id) REFERENCES city(city_id) ON DELETE NO ACTION ON UPDATE CASCADE;
GO
...
ADD CONSTRAINT [DF_language_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
ADD CONSTRAINT [DF_category_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
ADD CONSTRAINT [DF_customer_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
ALTER TABLE customer
ADD CONSTRAINT [DF_customer_create_date] DEFAULT(GETDATE()) FOR create_date;
GO
...
GO
ALTER TABLE film
ADD CONSTRAINT CHECK_special_features CHECK(special_features IS NULL
...
GO
ALTER TABLE film
ADD CONSTRAINT [DF_film_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
ADD CONSTRAINT [DF_film_actor_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
ADD CONSTRAINT [DF_film_category_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
ADD CONSTRAINT [DF_inventory_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE staff
ADD CONSTRAINT [DF_staff_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE store
ADD CONSTRAINT [DF_store_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE payment
ADD CONSTRAINT [DF_payment_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
GO
ALTER TABLE rental
ADD CONSTRAINT [DF_rental_last_update] DEFAULT(GETDATE()) FOR last_update;
GO
...
-- FK CONSTRAINTS
ALTER TABLE customer
ADD CONSTRAINT fk_customer_store FOREIGN KEY(store_id) REFERENCES store(store_id) ON DELETE NO ACTION ON UPDATE CASCADE;
GO
ALTER TABLE inventory
ADD CONSTRAINT fk_inventory_store FOREIGN KEY(store_id) REFERENCES store(store_id) ON DELETE NO ACTION ON UPDATE CASCADE;
GO
ALTER TABLE staff
ADD CONSTRAINT fk_staff_store FOREIGN KEY(store_id) REFERENCES store(store_id) ON DELETE NO ACTION ON UPDATE CASCADE;
GO
ALTER TABLE payment
...
GROUP_CONCAT(DISTINCT CONCAT(c.name, ': ',
		(SELECT GROUP_CONCAT(f.title ORDER BY f.title SEPARATOR ', ')
                    FROM DVDStore.film f
                    INNER JOIN DVDStore.film_category fc
                      ON f.film_id = fc.film_id
                    INNER JOIN DVDStore.film_actor fa
...
AS film_info
FROM DVDStore.actor a
LEFT JOIN DVDStore.film_actor fa
  ON a.actor_id = fa.actor_id
LEFT JOIN DVDStore.film_category fc
  ON fa.film_id = fc.film_id
LEFT JOIN DVDStore.category c
